 ...
 const {signIn , signOutUser , user} = useAuth();
  return (
    <div className="bg-white min-h-screen w-full  text-black">
     ...
     <div
     className="h-[60vh] w-[70vw] bg-cover bg-center rounded-2xl mt-10 flex items-center justify-center"
     style={{ backgroundImage: `url(${homeimage})` }}
      >
       <div className='text-center'>
       <h1 className='text-[60px] text-white font-bold'>Your Smart Note-Taking Companion</h1>
       ...
       <div className='mt-10 mb-20 flex gap-4 '>
              {/* //card 1  */}
              <div className='border-1 border-black/40 p-4  rounded-2xl hover:shadow-lg transition-shadow duration-300 hover:border-black/70'>
